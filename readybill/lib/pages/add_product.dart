...
import 'package:readybill/services/file_download_handler.dart';
...
class _AddInventoryState extends State<AddInventory> {
  ...
  //       print(jsonResponse);
  //       // Check if we have a successful status
  ...
  //         if (directory != null) {
  //           final filePath = '${directory.path}/new_file.xlsx';
  //           final file = File(filePath);

  //           // Get the actual file content from your response
  //           // If the API returns file content directly in bodyBytes:
  ...
  //         }
  //       } else {
  //         throw Exception('Export failed: ${jsonResponse['message']}');
  //       }
  //     } else {
